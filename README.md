...
Before running, preprocess data using `create_timestamps_dso.py` from [this repository](https://github.com/yx0123/timestamp_generator.git) This will create a `times.txt` text file which should be placed in the same folder as `image_left` (eg `~/16-833-Project-Datasets/eow_easy_P002/P002/times.txt`)
